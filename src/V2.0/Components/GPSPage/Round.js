...
var guestData = require('../../Component1/Home/GuestYouLikeData')
...
var Round = createReactClass({
    ...
    getRoundData() {
        return fetch('https://apis.map.qq.com/ws/place/v1/search?boundary=nearby(39.908491,116.374328,1000)&page_size=20&page_index=1&keyword=美食&orderby=_distance&key=TVHBZ-WUDCI-UZQGY-5544C-Z6IUV-WCFKD')
