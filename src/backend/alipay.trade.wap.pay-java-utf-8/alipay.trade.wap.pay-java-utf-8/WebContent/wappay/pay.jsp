...
if(request.getParameter("WIDout_trade_no")!=null){
	...
	String guid = new String(request.getParameter("WIDuid").getBytes("ISO-8859-1"),"UTF-8");
...
function GetQueryString(name){  
	...
	function GetDateNow() {
		...
		document.getElementById("WIDtotal_amount").value = "12";
        document.getElementById("WIDbody").value = sguid;
        document.getElementById("WIDuid").value = sguid;
	}
	GetDateNow();
</script>
</html>