...
public class TranslateText {
    ...
    private static Logger logger = LoggerFactory.getLogger(TranslateText.class);

    private static final String YOUDAO_URL = "http://openapi.youdao.com/api";

    private static final String APP_KEY = "356a681fd478dcea";
    ...
    public static String main(Text text) throws IOException {
        ...
        /** 处理结果 */
        return parseJson(requestForHttp(YOUDAO_URL,params));
    }

    // remove unwanted attribute
    public static String parseJson(String json) {
        JsonObject jsonObject = new JsonParser().parse(json).getAsJsonObject();
        String result = jsonObject.get("translation").getAsString();
