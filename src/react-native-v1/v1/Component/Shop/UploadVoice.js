...
var UploadVoice = createReactClass({
    ...
    componentDidMount () {
      ...
      //let animatedPhotoPath = this.state.voicePath + "/animated_photo.gif";
      //let voicePath = this.state.voicePath + "/photo.jpg";
      ...
      // RNFS.writeFile(voicePath, photo, "utf8")
      //   .then(success => {
      //     console.log("FILE WRITTEN!");
      //   })
      //   .catch(err => {
    ...
    render(){
        return (
          ...
          <TouchableOpacity onPress={() => {
            ...
            <Image style={{ width: 150, height: 100 }} source={require('./voice.png')}></Image>
            {/* <Text>Click</Text> */}
